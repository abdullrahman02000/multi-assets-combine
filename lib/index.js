...
async function appendElement(options) {
  ...
  if (typeof element === "string") {
    ...
    if (typeof path === "string") {
      ...
      if (
        !(
          typeof removeLink === "object" && typeof removeLink[0] !== "undefined"
        )
      ) {
...
module.exports.combine = async function combine(config) {
  ...
  if (typeof input === "string" && typeof output === "string") {
    ...
    if (typeof(html)=='undefined') {
      inputHTML.insertAdjacentHTML('afterend', '<html></html>')
      html = inputHTML.querySelector("html")
    }
    ...
    if (!(typeof style === "object" && typeof style[0] !== "undefined")) {
    ...
    if (!(typeof script === "object" && typeof script[0] !== "undefined")) {
